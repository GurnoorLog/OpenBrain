...
export class FireworksArchitect extends BaseArchitect {
  ...
  override async askClarifyingQuestions(): Promise<string[]> {
    // Design-first: the architect never stalls on an intake interview. It
    // designs the best graph from the request and auto-adds capability nodes.
    return []
  }
